...
if __name__ == '__main__':
    ...
    parser.add_argument('input_folder', default= "./data/DataBackUp", help='the skeleton data folder name')
    parser.add_argument('output_folder', default= "./data/DataBackUp", help='the skeleton data folder name')
    ...
    P4_AS1_train = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS1_train.p", "rb"))
    print("Loading AS1_test  data ....")
    P4_AS1_test = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS1_test.p", "rb"))
    print("Loading AS2_train  data ....")
    P4_AS2_train = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS2_train.p", "rb"))
    print("Loading AS2_test  data ....")
    P4_AS2_test = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS2_test.p", "rb"))
    print("Loading AS3_train  data ....")
    P4_AS3_train = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS3_train.p", "rb"))
    print("Loading AS3_test  data ....")
    P4_AS3_test = pickle.load(
        open(args.input_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS3_test.p", "rb"))
    ...
    pickle.dump(
        [AS1_train_left_hand, AS1_train_right_hand, AS1_train_left_leg, AS1_train_right_leg, AS1_train_central_trunk,
         AS1_train_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS1_train.p", "wb"))
    pickle.dump(
        [AS2_train_left_hand, AS2_train_right_hand, AS2_train_left_leg, AS2_train_right_leg, AS2_train_central_trunk,
         AS2_train_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS2_train.p", "wb"))
    pickle.dump(
        [AS3_train_left_hand, AS3_train_right_hand, AS3_train_left_leg, AS3_train_right_leg, AS3_train_central_trunk,
         AS3_train_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS3_train.p", "wb"))
    pickle.dump(
        [AS1_test_left_hand, AS1_test_right_hand, AS1_test_left_leg, AS1_test_right_leg, AS1_test_central_trunk,
         AS1_test_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS1_test.p", "wb"))
    pickle.dump(
        [AS2_test_left_hand, AS2_test_right_hand, AS2_test_left_leg, AS2_test_right_leg, AS2_test_central_trunk,
         AS2_test_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS2_test.p", "wb"))
    pickle.dump(
        [AS3_test_left_hand, AS3_test_right_hand, AS3_test_left_leg, AS3_test_right_leg, AS3_test_central_trunk,
         AS3_test_Labels], open(args.output_folder + "/MSRAction3D_real_world_" + protocol + "_Split_AS3_test.p", "wb"))
    ...
    # Florence3D_all = []
    # for i in range(10):
    #     Florence3D_DataSet = pickle.load(open("./data/DataBackUp/Florence3D_DataSet.p", "rb"))
    ...
    # pickle.dump(Florence3D_all,open("./data/Florence3D_DataSet.p", "wb"))
    # print("Florence3D_DataSet created!")
    # print("-------------------------------------------------------------------------------")

    # print("-------------------------------------------------------------------------------")
    # print("Loading UTKinect_DataSet ....")
    # UTKinect_DataSet = pickle.load(open("./data/DataBackUp/UTKinect_DataSet.p", "rb"))
    ...
    # HDM05_DataSet = pickle.load(open("./data/DataBackUp/HDM05_DataSet.p", "rb"))
