...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='load msr skeletons description')
    ...
    if flag_created:
        ...
        pickle.dump([AS2_train_left_hand, AS2_train_right_hand, AS2_train_left_leg, AS2_train_right_leg, AS2_train_central_trunk, AS2_train_Labels, max_frames[1]], open("./data/DataBackUp/MSRAction3D_real_world_P4_Split_AS2_train.p", "wb"))
        pickle.dump([AS3_train_left_hand, AS3_train_right_hand, AS3_train_left_leg, AS3_train_right_leg, AS3_train_central_trunk, AS3_train_Labels, max_frames[2]], open("./data/DataBackUp/MSRAction3D_real_world_P4_Split_AS3_train.p", "wb"))
